...
def generar_texto(tipo: str, caso: dict, fiscal_nombre: str,
    ...
    if tipo == "acta_restriccion":
        ...
        plazo = (extra or {}).get("plazo_dias", 90)
        cuerpo = (
            f"En la localidad sede de esta {unidad}, a los {_fecha()}, comparece ante la "
            f"Fiscalía interviniente el/la ciudadano/a {imp}, a quien se le NOTIFICA de la "
            f"medida dispuesta en el marco de los autos caratulados {caratula}.\n\n"
            "RESOLUCIÓN DEL FISCAL — MEDIDAS RESTRICTIVAS:\n\n"
            "Atento a las constancias de autos, y en virtud del Art. 72 de la Ley 10.326 "
            "(CCC) y Arts. 10 y 21 de la Ley 9283 (Violencia Familiar), este Ministerio "
            "Público Fiscal RESUELVE establecer las siguientes medidas restrictivas:\n\n"
            f"   1. RESTRICCIÓN DE ACERCAMIENTO: Se prohíbe a {imp} acercarse a {vic} y a "
            f"su domicilio sito en {dom_vic}, a una distancia menor a 200 (doscientos) metros.\n"
            f"   2. PROHIBICIÓN DE COMUNICACIÓN: Se prohíbe a {imp} mantener todo tipo de "
            f"comunicación verbal, telefónica, digital o por intermedio de terceros con {vic}.\n"
            f"   3. PLAZO: Las medidas se extienden por el término de {plazo} días corridos "
            "desde la presente notificación, hasta que tome intervención el Juzgado competente.\n"
            "   4. CARÁCTER RECÍPROCO: Las medidas de restricción son de carácter recíproco "
            "entre las partes.\n\n"
            "Se hace saber al/la compareciente que el incumplimiento configura la "
            "contravención prevista en el Art. 85 de la Ley 10.326 (desobediencia a "
            "disposición fiscal) y podrá motivar la extensión del plazo y/o la elevación de "
            "las actuaciones al Juez Contravencional."
            + _doble_firma(imp, dni, fiscal_nombre)
        )
        return titulo, cuerpo
