...
def generar_texto(tipo: str, caso: dict, fiscal_nombre: str,
    ...
    if tipo == "dictamen_mediacion":
        ...
        cuerpo = (
            ...
            f"descripta en el parte policial adjunto, encuadrable en el {art_num} de la Ley "
    ...
    if tipo == "dictamen_suspension":
        ...
        cuerpo = (
            ...
            f"se encuentra imputado/a de la conducta prevista por el {art_num} de la Ley "
            ...
            "correspondiendo imponer instrucciones especiales (art. 43 del CCC).\n\n"
            "CONSIDERANDO:\n\n"
    ...
    if tipo == "decreto_suspension":
        ...
        cuerpo = (
            ...
            "a prueba, con imposición de instrucciones especiales (art. 43 del CCC), y "
            "habiendo acordado las condiciones que se detallan, corresponde hacer lugar a "
            "la suspensión.\n\n"
            ...
            "(art. 44 del CCC — incumplimiento de instrucción especial).\n\n"
    ...
    if tipo == "requerimiento":
        ...
        cuerpo = (
            ...
            f"en la conducta encuadrable en el {art_num} de la Ley Provincial N° 10.326.\n\n"
            ...
            f"   2. Se convoque a {imp} a audiencia (art. 137 del CCC).\n"
    ...
    if tipo == "certificado_cumplimiento":
        ...
        cuerpo = (
            ...
            "ÍNTEGRO Y SATISFACTORIO a la totalidad de las condiciones (instrucciones "
            "especiales, art. 43 del CCC) impuestas en el marco de la suspensión del proceso "
            "contravencional a prueba.\n\n"
            ...
            "las instrucciones especiales (art. 43 del CCC), corresponde tener por cumplida "
            "la suspensión y disponer el ARCHIVO de las actuaciones.\n\n"
