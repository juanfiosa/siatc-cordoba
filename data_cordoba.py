...
TIPOS_INFRACCION = {
    ...
    "transito_uso_celular": {
        "label": "Uso de teléfono celular al conducir",
        "categoria": "Tránsito",
        "articulo": "Art. 79 CCC",
        "gravedad_base": 2,
        "es_conflicto_vecinal": False,
    ...
    "transito_estacionamiento": {
        "label": "Estacionamiento indebido (zona prohibida / dársena)",
        "categoria": "Tránsito",
        "articulo": "Art. 83 CCC",
        "gravedad_base": 1,
        "es_conflicto_vecinal": False,
    ...
    "transito_contramano": {
        "label": "Circular en contramano",
        "categoria": "Tránsito",
        "articulo": "Art. 77 inc. d CCC",
        "gravedad_base": 2,
        "es_conflicto_vecinal": False,
        "frecuencia": "media",
    },
    ...
    "quema_residuos": {
        "label": "Quema de residuos / materiales en espacio público",
        "categoria": "Espacio Público",
        "articulo": "Art. 59 CCC",
        "gravedad_base": 2,
        "es_conflicto_vecinal": False,
