...
if _seccion == "nueva_causa":
    ...
    with col_izq:
        ...
        dni_input = st.text_input("D.N.I.", value="",
        ...
        dom_default    = persona_encontrada.get("domicilio","") if persona_encontrada else ""
        tel_default    = persona_encontrada.get("telefono","")  if persona_encontrada else ""
